...
runOnGPU = true;
tic
[Cai2013_Regul_iterates, Cai2013_Regul_costs ]= Cai2013(y, ObjectSize, A, M, S, k_d, MaxIters, T, regulWeights, delta_h, runOnGPU);
toc

% Show the resulting sequence of iterates
PlayIterates(Cai2013_Regul_iterates, [0 0 0], [0.015 0.015 1.5])

% Plot the resulting costs, in loglog scale
loglog(Cai2013_Regul_costs - min(Cai2013_Regul_costs(:)));
