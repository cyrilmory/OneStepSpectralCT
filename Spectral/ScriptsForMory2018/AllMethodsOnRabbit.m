...
S = cat(1, sum(S_unbinned(31:49, :, :), 1), ...
           sum(S_unbinned(50:63, :, :), 1), ...
           sum(S_unbinned(64:71, :, :), 1), ...
           sum(S_unbinned(72:84, :, :), 1), ...
           sum(S_unbinned(85:end, :, :), 1));
...
% Run Cai2013
NbIters = 5000;
regulWeights = [1000, 1000, 1];
[Cai2013_iterates, Cai2013_costs ]= Cai2013(y, ObjectSize, A, M_fessler, normalized_S, k_d, NbIters, T_fessler, regulWeights, delta_huber, runOnGPU);
